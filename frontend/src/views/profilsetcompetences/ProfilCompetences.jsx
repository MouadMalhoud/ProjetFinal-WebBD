...
import './ProfilCompetences.css'

export default function ProfilCompetences(){
    return(
        <>
        <div className='hero'><h1>Profils et Competences</h1></div>
            <div className='container'>
                <div className='container2'>
                    <h2>Etudiants en Gestion de réseaux et sécurité</h2>
                    <p>Nos étudiants en Gestion de réseaux et sécurité ont suivi des cours leur permettant de:
                ...
                <div className='container2'>
                    <h2>Etudiants en Développement d'applications</h2>
                    <p>Nos étudiant en Développement d'applications informatiques ont suivi des cours leur permettant de:
